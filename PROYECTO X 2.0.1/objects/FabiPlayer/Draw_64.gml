draw_text(50, 70, string("Vidas=") + string(hp)); 
draw_text(50, 30, string("Puntos=") + string(Punto));
...
global.tiempo_jugado = texto_hora + ":" + texto_minutos + ":" + texto_segundos;
draw_text(500, 20,global.tiempo_jugado);